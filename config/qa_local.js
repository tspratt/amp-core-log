...
var SvcConfig = function(){
    ...
    this.replSet = new ReplSetServers( [
            new Server( 'qa1.promo-qa.internal', 27017, { auto_reconnect: true } ),
            new Server( 'qa2.promo-qa.internal', 27018, { auto_reconnect: true } ),
            new Server( 'qa3.promo-qa.internal', 27019, { auto_reconnect: true } )
        ],
        {rs_name:'rs0'}
    );
